...
class DataProvider extends ChangeNotifier {
  ...
  void filterProducts(String keyword) {
    if (keyword.isEmpty) {
      ...
      _filteredProducts = _allProducts.where((product) {
        ...
        //? you  can add more conditions here if there are more fileds to match against
  ...
  void filterProductsByQuantity(String productQutType) {
    if (productQutType == 'All Product') {
      ...
      _filteredProducts = _allProducts.where((product) {
        //? filter products with quantity equal to 3 (out of stock)
        return product.quantity != null && product.quantity == 3;
      }).toList();
    } else if (productQutType == 'Other Stock') {
      _filteredProducts = _allProducts.where((product) {
        //? filter products with quantity equal to 0 or 3 (out of stock)
